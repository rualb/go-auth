...
const testOnlyUserID = "test-only-user-id"
const testOnlyUserPhone = "+999121234567"
...
func setup() func() {
	...
	os.Setenv("APP_IDENTITY_IS_AUTH_PHONE", "true")
	os.Setenv("APP_IDENTITY_PHONE_NUMBER_PREFIX", "+999")
...

	{
		...
		testUserAcc.PhoneNumber = testOnlyUserPhone
...
func TestAuthTokenDump(t *testing.T) {
	...
	// // /app/home/postgres/bin/psql -d postgres -U postgres -c "update user_accounts set roles='admin' where id = 'test-only-user-id'"
